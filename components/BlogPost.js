            ...
            return post.tags.length > 0 ?
              <div>
                <p className="tags"> Tags :
                  {post.tags.map((tag) => {
                    return (
                      <Link route="tags" params={{ name: tag.tagName }}
                            className="label tag"><a>{tag.tagName}</a></Link>
                    );
                  })}
                </p>
                < p className="share"> Follow :
                  ...
                  <span data-url-wrap="http://www.facebook.com/allovince"><i
                    className="icon-social-facebook-squared"></i></span>
                  <span
